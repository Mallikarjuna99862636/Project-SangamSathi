...
import "./freeuserviewall.scss";
import FavoriteIcon from "@mui/icons-material/Favorite";
import premiumimg from "../../../../assets/images/premiumImg.jpg";
import CancelIcon from "@mui/icons-material/Cancel";
import AboutPop from "./popupContent/aboutPop/FreeAboutPop";
import FamilyPop from "./popupContent/familyPop/FreeFamilyPop";
import EducationPop from "./popupContent/educationPop/FreeEducationPop";
import LifestylePop from "./popupContent/lifeStylePop/FreeLifestylePop";
import PreferencePop from "./popupContent/preferencePop/FreePreferencePop";
              ...
              <Box className="user-other-details">
                ...
                <Box className="viewall-tabs-list">
                  <Box>
                    ...
                    >
                      <Tab
                        className="viewall-tab-names-list-01"
                        label="About"
                      />
                      <Tab
                        className="viewall-tab-names-list-02"
                        label="Family"
                      />
                      <Tab
...
export default FreeUserViewAll;
